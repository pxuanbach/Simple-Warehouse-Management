...
namespace WarehouseManagement
{
    public partial class FMain : Form
    {
        ...
        public FMain(string Username, int Position)   //Đầu vào Username. Position
        {
            InitializeComponent();
            MyUserName = Username;
        ...
        private void BtStock_Click(object sender, EventArgs e)
        {
            ...
            BtSta.BackColor = Color.FromArgb(239, 242, 235);
            BtSta.ForeColor = Color.FromArgb(73, 80, 87);
            BtSta.IconColor = Color.FromArgb(73, 80, 87);
            BtSta.Font = new Font("Calibri", 15, FontStyle.Bold);
            ...
            BtAbout.BackColor = Color.FromArgb(239, 242, 235);// CHuyển màu button Oder
            BtAbout.ForeColor = Color.FromArgb(73, 80, 87);
            BtAbout.IconColor = Color.FromArgb(73, 80, 87);
            BtAbout.Font = new Font("Calibri", 15, FontStyle.Bold);
            #endregion
        ...
        {
            //Đổi màu bt Sta
            BtSta.BackColor = Color.FromArgb(223, 159, 163);// CHuyển màu button Sta
            BtSta.ForeColor = Color.FromArgb(255, 255, 255);
            BtSta.IconColor = Color.FromArgb(255, 255, 255);
            BtSta.Font = new Font("Calibri", 16, FontStyle.Bold);
        ...
        private void BtAbout_Click(object sender, EventArgs e)
        {
            ...
            BtAbout.BackColor = Color.FromArgb(162, 172, 164);// CHuyển màu button About
            BtAbout.ForeColor = Color.FromArgb(255, 255, 255);
            BtAbout.IconColor = Color.FromArgb(255, 255, 255);
            BtAbout.Font = new Font("Calibri", 16, FontStyle.Bold);
