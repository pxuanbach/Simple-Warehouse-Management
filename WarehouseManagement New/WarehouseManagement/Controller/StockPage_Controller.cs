...
namespace WarehouseManagement.Controller
{
    class StockPage_Controller
    {
        ...
        public bool Sua_HangHoa(string New_MAHANG, string TENHANG, string DVT, int SOLUONG, float DONGIA, DateTime NGNHAP, DateTime NGSANXUAT, DateTime HSD, string MAHANG)
        {
            ...
            return stock.Sua_HangHoa(New_MAHANG, TENHANG, DVT, SOLUONG, DONGIA, nhap, xuat, hsd, MAHANG);
        }
