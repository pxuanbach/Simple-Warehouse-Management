    ...
    public partial class FAdd : Form
    {
        ...
        private void buttonADD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (controller.Check_HangHoa(tBMaHang.Text, MyUkey))
                {
                    if (controller.Update_HangHoa(tBMaHang.Text, tBTenHang.Text, tBDVT.Text, 
                        Convert.ToInt32(tBSoLuong.Text), Convert.ToInt32(donGia[0]), 
                        dTPNgNhap.Value, dTPNSX.Value, dTPHSD.Value, MyUkey))
                    {
                ...
                {
                    if (controller.Them_HangHoa(tBMaHang.Text, tBTenHang.Text, tBDVT.Text, Convert.ToInt32(tBSoLuong.Text),  //Thêm 1 hàng
