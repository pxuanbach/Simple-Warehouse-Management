...
namespace WarehouseManagement.Model
{
    class StockPage_Model
    {
        ...
        public bool Xoa_HangHoa(string MAHANG, int UKEY, int Position)
        {
            string sql_del = $"delete from HANGHOA where MAHANG = '{MAHANG}'";
            if (Position == 2)
                sql_del = sql_del + "AND UKEY = " + UKEY;
            bool re = false;
        ...
        public bool Check_HangHoa_In_CTHD(string MAHANG, int UKEY, int Position)
        {
            string sql_select = "Select MAHOADON From CTHD Where MAHANG = " + MAHANG;
        ...
        public string getTenHang(string TENHANG, int UKEY, int Position)
        {
            string sql_select = "select TENHANG from HANGHOA where TENHANG = N'" + TENHANG + "' ";
            if (Position == 2)
            {
