...
namespace WarehouseManagement.Model
{
    class AccountPage_Model
    {
        public Account getInformation(int UKEY)
        {
            ...
            string sql_sel_info  = "Select HOTEN, SDT, BIRTHDAY, GIOITINH, EMAIL, POSITION  From USERACC Where UKEY = " + UKEY;
        ...
        {
            string sql_update = "update USERACC set USERPASS = '" + Process.Encrypt(newpass) + 
                "' where USERPASS = '" + Process.Encrypt(oldpass) + "' and USERNAME = '" + account + "'";
            bool ck = false;
