...
namespace WarehouseManagement.Model
{
    class Admin_Model
    {
        ...
        public bool Sua_USERACC(int UKEY, string username, int UKEY_OLD, string Position)
        {
            string sql_update;
            sql_update = "update USERACC set USERNAME ='"+ username + "',POSITION ='" + Position + "', UKEY = " + UKEY+" where UKEY = " + UKEY_OLD;
            bool re = false;
