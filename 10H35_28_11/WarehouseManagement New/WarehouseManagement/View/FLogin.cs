        ...
        private void buttonSignIn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (login.checkAdmin(textBoxUName.Text, textBoxUPass.Text) == true)
                        {
                            FormAdmin admin = new FormAdmin(textBoxUName.Text);
                            this.Hide();
                            admin.ShowDialog();
                            this.Show();
                        }
                    ...
                    if ((radioButtonAdmin.Checked == radioButtonUser.Checked) && (radioButtonAdmin.Checked == false))
                    {
                        MessageBox.Show("Click user or admin please");
                    }
                }
